        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('perfil.actualizar') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" value="{{ Auth::user()->plan->nombre ?? 'Gratuito' }}" readonly>
                </div>

                <div class="d-flex justify-content-between align-items-center">
                    <button type="submit" class="btn btn-primary">Actualizar perfil</button>
                    <a class="btn btn-outline-secondary" href="{{ route('password.change.form') }}">Cambiar Contraseña</a>
                </div>
            </form>
